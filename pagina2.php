      ...
      <div class="heading_container">
        ...
        <table WIDTH="80%" HEIGHT="20%" style="text-align: center">
            <thead class="table-dark">
                <tr >
                  <th style="background: rgba(128, 255, 0, 0.3); border: 1px solid rgba(100, 200, 0, 0.3);">Motivo de consulta 1</th>
                  <th style="background: rgba(0, 211, 255, 0.3); border: 1px solid rgba(100, 200, 0, 0.3);">Motivo de consulta 2</th>
                  <th style="background: rgba(255, 99, 71, 0.6); border: 1px solid rgba(100, 200, 0, 0.3);">Motivo de consulta 3</th>
                </tr>
            </thead>
            <tbody>
                <tr style="border: white">
                  <td style="background: rgba(128, 255, 0, 0.3); border: 1px solid rgba(100, 200, 0, 0.3);">folio: , Nombre: , estatus
                    <br>
                    <button type="button" class="btn btn-outline-success">revisar</button>
                  </td>
                  <td style="background: rgba(0, 211, 255, 0.3); border: 1px solid rgba(100, 200, 0, 0.3);">folio: , Nombre: , estatus
                    <br>
                    <button type="button" class="btn btn-outline-primary">revisar</button>
                  </td>
                  <td style="background: rgba(255, 99, 71, 0.6); border: 1px solid rgba(100, 200, 0, 0.3);">folio: , Nombre: , estatus
                    <br>
